...
import {FilterArg, FilterArgBool, filterArgConfig, FilterArgNumber, FilterArgString} from "../config/filters";
import {Form, Input, Slider, Switch} from "antd";

export const DynamicField: FC<{ name: string, config: FilterArg, value: unknown }> = ({name, config, value}) => {
